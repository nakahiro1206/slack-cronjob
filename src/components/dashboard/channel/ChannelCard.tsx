...
export const ChannelCard: FC<Props> = ({ channel, users, refetchChannels }) => {
    ...
    const [isUpdateChannelDialogOpen, setIsUpdateChannelDialogOpen] = useState(false);
    const {mutate: removeUsersMutation, isPending: loadingRemoveUsersMutation } = trpc.channel.removeUsers.useMutation();
    const {mutate: deleteChannelMutation, isPending: loadingDeleteChannelMutation } = trpc.channel.delete.useMutation();
    const { mutate: updateChannelMutation, isPending: loadingUpdateChannelMutation } = trpc.channel.update.useMutation();
    ...
    const handleDeleteChannel = () => {
        deleteChannelMutation({ channelId: channel.channelId }, {
            onSuccess: (result) => {
                if (result.success) {
