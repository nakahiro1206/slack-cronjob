...
export const UserSelectDialogButton = ({ channelId, unregisteredUsers, refetchChannels }: { channelId: string, unregisteredUsers: User[], refetchChannels: () => void }) => {
    const [isOpen, setIsOpen] = useState(false);
    const handleClose = () => setIsOpen(false);
    const [selectedUserIds, setSelectedUserIds] = useState<string[]>([]);
    const {mutate: registerUsersMutation, isPending: loadingRegisterUsersMutation } = trpc.upcoming.registerUsers.useMutation();
