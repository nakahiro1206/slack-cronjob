...
- Re-organize the order based on the initial order and given user's request.
- user tag is represented as <@user_id>. In your response you should keep this format in your response.
